...
document.getElementById('deleteButton').addEventListener('click', function() {
	...
	//import {deleteProject} from 'SQLStatements.js';
...
document.getElementById('projectForm').addEventListener('submit', function(event) {
    ...
    //import {updateProject} from 'SQLStatements.js';
    //updateProject(userID, projectID, title, description, renewal, priority, deadline);
