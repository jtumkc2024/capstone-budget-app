...
/* Listen to addCardform submission event */
addCardForm.addEventListener('submit', function (event) {
	...
	//import {addCard} from 'SQLStatements.js';
...
function validateForm() {
    ...
    if (!expiryDate.value) {
        ...
        showError(expiryDate, 'Unknown error. Double check all fields.');
        isValid = false;
    }
	...
	showError(securityCode, 'Unknown error. Double check fields.');
        isValid = false;
    }
